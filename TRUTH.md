...
|---:|---|---|---|---|
| 1 | Sheets | ACCEPTANCE_BLOCKED | IN_PROGRESS | UI-01 native visual review, very slow large-workbook recovery, synchronous file operations/full replacements, full visual/accessibility coverage, broader interoperability, native million-cell scroll, and reviewed app memory budget remain |
