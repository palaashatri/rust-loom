...
|---:|---|---|---|---|
| 1 | Sheets | IN_PROGRESS | IN_PROGRESS | UI-01 menu discoverability, full visual/interoperability/performance checks, and broader accessibility coverage remain |
