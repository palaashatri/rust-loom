...
*macOS native window capture (`screencapture -l`) of the current build. A pixel-reproducible renderer capture of the same state is at [docs/screenshot-deterministic.png](docs/screenshot-deterministic.png) (`cargo run -p loom-photo-app -- --screenshot docs/screenshot-deterministic.png --size 1280x800 --theme light`).*
